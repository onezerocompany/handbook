...
Swift is used for OneZero's native iOS development, exclusively with SwiftUI for user interfaces. We target the latest stable Swift version and support iOS versions from latest minus 2 (currently iOS 16+). Our Swift standards emphasize safety, modern concurrency, and protocol-oriented programming.
