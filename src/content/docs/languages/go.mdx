...
Go is used at OneZero for performance-critical services and systems programming. We target the latest stable Go version and follow Go's idiomatic patterns and conventions. Our Go standards emphasize simplicity, explicit error handling, and leveraging the standard library.
