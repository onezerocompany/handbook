...
Databases are critical infrastructure for OneZero applications. We primarily use PostgreSQL for production data storage and SQLite for local development and testing. Our database standards ensure data integrity, performance, and maintainability.
...
12. Normalize database schemas to reduce redundancy
13. Use constraints (NOT NULL, UNIQUE, FOREIGN KEY, CHECK)
14. Enforce data rules at database level
15. Add indexes based on query analysis, not speculation
16. Profile queries to identify slow operations
17. Use soft deletes or hard deletes based on data type and requirements
18. Decide deletion strategy based on retention needs and regulations
19. Store seed data in version-controlled files
20. Make seed scripts idempotent
21. Never seed production databases automatically
22. Add indexes where they provide measurable performance improvement
23. Balance read and write performance with indexing
24. Index foreign keys used in joins
25. Index columns used in WHERE and ORDER BY clauses
26. Use composite indexes for multi-column queries
27. Optimize queries through proper indexing and design
28. Avoid N+1 queries with eager loading
29. Use EXPLAIN to analyze query performance
30. Use transactions for atomic operations
31. Wrap related operations in transactions
32. Use ORM transaction APIs
33. Configure connection pools based on concurrency and capacity
34. Validate data at application, ORM, and database layers
35. Automate database backups through platform systems
36. Test restoration procedures regularly
37. Enable point-in-time recovery
38. Use snake_case for table and column names
39. Use plural table names (users, posts)
40. Use singular, descriptive column names
41. Use {table}_id format for foreign keys
42. Track schema version through migration tables
43. Let migration tools manage schema versions
44. Apply migrations in correct order automatically
