...
Flutter is used at OneZero for cross-platform mobile applications when we're not using Expo. Flutter provides native performance on iOS and Android with a single codebase. Our Flutter standards emphasize reactive state management, widget composition, and platform-appropriate design.
...
25. Implement comprehensive theming with ThemeData
26. Support light and dark themes
27. Respect system theme preferences
28. Use pub package manager for dependencies
29. Keep dependencies up to date with automated updates
30. Follow Flutter and Dart conventions
31. Use Dart analyzer and formatter for code style
32. 2-space indentation required
33. Run formatter in pre-commit hooks
34. Optimize widget rebuilding with const constructors
35. Implement image caching
36. Use lazy loading for lists and heavy content
37. Profile app regularly for performance bottlenecks
38. Use snake_case for variables and functions
39. Use PascalCase for classes and widgets
40. Maximum function length is 50 lines
41. Tests required for all new features and bug fixes
