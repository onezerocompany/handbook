...
Native Android development at OneZero uses Kotlin with Jetpack Compose for UI. We target the latest stable Kotlin version and support a minimum Android API level 31 (Android 12). Our Android apps emphasize Material Design, reactive programming, and deep Android platform integration.
